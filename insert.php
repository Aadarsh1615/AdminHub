    ...
    <div class="container">
        ...
        <div class="right-panel">
            <form class="login-form" method="POST" action="process.php">
                ...
                <input type="text" placeholder="Name" required class="styled-input" name="fullname">
                <input type="email" placeholder="Email" required class="styled-input" name="email">
                <input type="password" placeholder="Password" required class="styled-input" name="password">
                <input type="password" placeholder="Confirm password" required class="styled-input" name="confirm_password">
                <div class="options">
                    <label>
